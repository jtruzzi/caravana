            ...
            return (
              <>
                      ...
                      <>
                        {formik.values?.cuigs?.map((cuig, index) => (
                          ...
                          >
                            <TextInput
                              ...
                              value={cuig}
                              style={tailwind(
                                "text-xl border rounded px-2 my-2 flex-grow mr-2"
                              )}
                            />
                            <TouchableOpacity
                              onPress={() => arrayHelpers.remove(index)}
                              style={tailwind(
                                "justify-center items-center px-4 h-10 rounded bg-red-600 my-2"
                              )}
                            >
                        ...
                        <View style={tailwind("w-full flex flex-row")}>
                          <TouchableOpacity
                            ...
                            style={tailwind(
                              "justify-center items-center px-4 h-10 rounded bg-green-600 my-2"
                            )}
                          >
                            <MaterialCommunityIcons
                              name={"plus"}
                ...
                <TouchableOpacity
                  ...
                  style={tailwind(
                    `flex flex-row justify-center items-center px-4 h-10 rounded bg-green-600 my-2 ${
                      formik.isSubmitting || !formik.dirty ? "bg-black" : ""
                    }`
                  )}
                >
